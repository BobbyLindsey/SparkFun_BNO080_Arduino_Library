...
uint16_t BNO080::parseInputReport(void)
{
	...
	else if (shtpData[5] == SENSOR_REPORTID_RAW_GYROSCOPE)
	{
		...
		memsRawGyroY = data2;
		memsRawGyroZ = data3;
		memsRawGyroTemperature = data4;
		memsRawGyroTimestamp = (data5 | (data6 << 16));
	}
...
int16_t BNO080::getRawGyroTemperature()
{
	return (memsRawGyroTemperature);
}
int16_t BNO080::getRawGyroTimestamp()
{
	return (memsRawGyroTemperature);
}
